...
\input{vektor/geometrien}
\input{vektor/addition.tex}
\input{vektor/skalar.tex}
\input{vektor/add_scalar.tex}
\input{vektor/vektorrum.tex}
\input{vektor/linearsys.tex}
\section{Practice Problems}
Dette afsnit vil behandle de givne opgaver fra forelæsnignerne til kapitlet.
\input{vektor/exercises/2.14.1.tex}
\input{vektor/exercises/2.14.2.tex}
\input{vektor/exercises/2.14.3.tex}
\input{vektor/exercises/exercise2.tex}